...
export class TableService {
    ...
    public async createTableRecords<T extends TableRecord = TableRecord>(
        ...
        try {
            ...
            console.error('[TableService.createTableRecords] Table:', table);
            console.error('[TableService.createTableRecords] Records array:', JSON.stringify(records, null, 2));
            console.error('[TableService.createTableRecords] Params:', JSON.stringify(params, null, 2));
