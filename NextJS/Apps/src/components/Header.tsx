        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="center" className="w-64 bg-white/50 dark:bg-[oklch(0.18_0.04_250)]/95 backdrop-blur-2xl border-white/30 dark:border-gray-700/50 shadow-2xl">
                {apps.map((app) => {
                  const Icon = getIcon(app.Icon);
                  const route = app.Route || '#';
                  return (
                    <DropdownMenuItem key={app.Application_ID} asChild>
                      <Link href={route} className="flex items-center gap-3 p-3 cursor-pointer rounded-md hover:bg-primary/10 transition-colors group">
