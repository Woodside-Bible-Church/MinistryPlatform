                  ...
                  <div className="group relative overflow-hidden border border-border bg-card hover:border-primary/50 dark:hover:border-[#61bc47]/50 hover:shadow-xl transition-all duration-300 cursor-pointer">
                    <div className="p-6 space-y-3">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="bg-primary/10 dark:bg-[#61bc47]/30 group-hover:bg-primary dark:group-hover:bg-[#61bc47] group-focus:bg-primary dark:group-focus:bg-[#61bc47] w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-all duration-300">
                          <Icon className="w-5 h-5 text-primary dark:text-[#61bc47] group-hover:text-white group-focus:text-white transition-colors duration-300" />
                        </div>
