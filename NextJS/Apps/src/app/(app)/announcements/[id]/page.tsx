...
export default function AnnouncementEditPage() {
    ...
    async function loadAnnouncement() {
      try {
        ...
        setFormData({
          ...
          sort: data.Sort,
          carouselSort: data.CarouselSort,
          carouselSortOverrides: data.CarouselSortOverrides,
  ...
  async function handlePreview() {
    ...
    const mockPreview: Announcement = {
      ...
      Sort: formData.sort,
      CarouselSort: formData.carouselSort,
      CarouselSortOverrides: formData.carouselSortOverrides,
