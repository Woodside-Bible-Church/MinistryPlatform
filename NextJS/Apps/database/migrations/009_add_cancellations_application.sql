-- =============================================
-- Migration: Add Cancellations Application
-- Description: Registers the Cancellations management app in the applications table
-- Date: 2026-01-25
-- =============================================

-- Insert Cancellations application
INSERT INTO applications (name, key, description, route, icon, sort_order, is_active, requires_auth)
VALUES (
  'Cancellations',
  'cancellations',
  'Manage campus closures and service cancellations',
  '/cancellations',
  'CloudOff',
  7,
  true,
