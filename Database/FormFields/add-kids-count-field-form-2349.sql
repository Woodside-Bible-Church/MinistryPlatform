...
-- ===================================================================
-- Form ID: 2349 (Christmas 2025 RSVP)
...
-- ===================================================================
IF NOT EXISTS (SELECT 1 FROM Forms WHERE Form_ID = 2349)
BEGIN
    PRINT 'ERROR: Form #2349 does not exist!'
    RETURN;
END

PRINT 'Form #2349 found - proceeding with field addition...'
PRINT ''
...
BEGIN
    PRINT 'WARNING: A field with label "Number of Kids" already exists for Form #2349'
...
VALUES (
    2349,                           -- Form_ID: Christmas 2025 RSVP
...
PRINT '✓ Successfully added "Number of Kids" field to Form #2349'
PRINT ''
