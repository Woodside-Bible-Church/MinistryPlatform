-- Add Available_Online filter to Cancellations Widget stored procedure
...
BEGIN
    ...
    CampusData AS (
        ...
        WHERE c.Domain_ID = @DomainID
            ...
            AND c.Available_Online = 1  -- Only show congregations available online
...
PRINT 'Updated stored procedure with Available_Online filter';
