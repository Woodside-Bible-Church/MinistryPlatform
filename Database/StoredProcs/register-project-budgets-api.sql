-- =============================================
-- Register api_Custom_GetProjectBudgets_JSON in MinistryPlatform
...
IF NOT EXISTS (SELECT 1 FROM dp_API_Procedures WHERE Procedure_Name = 'api_Custom_GetProjectBudgets_JSON')
BEGIN
    ...
    VALUES (
        ...
        'Get project budget data in JSON format for budget management UI'
    );
...
WHERE Procedure_Name = 'api_Custom_GetProjectBudgets_JSON';
...
WHERE ap.Procedure_Name = 'api_Custom_GetProjectBudgets_JSON';
