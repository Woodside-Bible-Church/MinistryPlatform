-- Register api_Custom_GetProjectPurchaseRequests_JSON in MinistryPlatform
-- Get project purchase requests with optional filter by requester
...
WHERE Procedure_Name = 'api_Custom_GetProjectPurchaseRequests_JSON';
...
WHERE ap.Procedure_Name = 'api_Custom_GetProjectPurchaseRequests_JSON';
