            ...
            return (
              ...
              (n = [
                ...
                },
                {
                  ...
                  value: function () {
                    if (
                      null !== document.getElementById("MPWidgets") &&
                      void 0 !== document.getElementById("MPWidgets")
                    ) {
                      var t = document.getElementById("MPWidgets").src;
                      if (t) {
                        var e = t.substring(0, t.indexOf(this.SCRIPT_NAME));
                        return (sessionStorage.appRoot = e), e;
                      }
                      console.log(
                        "Error: Could not find script in header of page with id='MPWidgets'"
                      );
                    }
                  }
                },
